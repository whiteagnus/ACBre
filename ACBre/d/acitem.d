...
@42 DO ~IncrementGlobal("ACBERROBOOK","LOCALS",1)~
...
==BGARRI IF ~InParty("GARRICK")See("GARRICK")!StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN @49
...
==BYESLI IF ~InParty("YESLICK")See("YESLICK")!StateCheck("YESLICK",CD_STATE_NOTVALID)~ THEN @53
...
==BEDWIN IF ~InParty("EDWIN")See("EDWIN")!StateCheck("EDWIN",CD_STATE_NOTVALID)~ THEN @62
EXIT
...
==BDYNA IF ~InParty("DYNAHEIR")See("DYNAHEIR")!StateCheck("DYNAHEIR",CD_STATE_NOTVALID)~ THEN @71
...
==BIMOEN2 IF ~InParty("IMOEN2")See("IMOEN2")!StateCheck("IMOEN2",CD_STATE_NOTVALID)~ THEN @87 = @88 = @89
==ACBREJ IF ~InParty("IMOEN2")See("IMOEN2")!StateCheck("IMOEN2",CD_STATE_NOTVALID)~ THEN @90
EXIT
...
==BJAHEIR IF ~InParty("JAHEIRA")See("JAHEIRA")!StateCheck("JAHEIRA",CD_STATE_NOTVALID)~ THEN @97
...
==BJAHEIR IF ~InParty("JAHEIRA")See("JAHEIRA")!StateCheck("JAHEIRA",CD_STATE_NOTVALID)~ THEN @100
EXIT

CHAIN
IF WEIGHT #5 ~Global("ACMISC97","LOCALS",1)~ THEN ACBREJ MISC97
@101 DO ~SetGlobal("ACMISC97","LOCALS",2)~
==BKIVAN IF ~InParty("KIVAN")See("KIVAN")!StateCheck("KIVAN",CD_STATE_NOTVALID)~ THEN @102
==ACBREJ IF ~InParty("KIVAN")See("KIVAN")!StateCheck("KIVAN",CD_STATE_NOTVALID)~ THEN @103
==BKIVAN IF ~InParty("KIVAN")See("KIVAN")!StateCheck("KIVAN",CD_STATE_NOTVALID)~ THEN @104
