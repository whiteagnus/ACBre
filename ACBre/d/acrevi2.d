...
IF ~~ THEN ACREVI2 1
@16
==BBRANW IF ~InParty("BRANWEN")InMyArea("BRANWEN")!StateCheck("BRANWEN",CD_STATE_NOTVALID)Global("ACREVIBRAN","LOCALS",0)~ THEN @17 DO ~SetGlobal("ACREVIBRAN","LOCALS",1)~
END
++ @8 + 2
++ @3 + 3
++ @4 + 4
...
==ACBREB IF ~InParty("ACBRE")InMyArea("ACBRE")!StateCheck("ACBRE",CD_STATE_NOTVALID)~ THEN @14
==BMINSC IF ~InParty("MINSC")InMyArea("MINSC")!StateCheck("MINSC",CD_STATE_NOTVALID)~ THEN @19
==BVICONI IF ~InParty("VICONI")InMyArea("VICONI")!StateCheck("VICONI",CD_STATE_NOTVALID)~ THEN @20
==BJAHEIR IF ~InParty("JAHEIRA")InMyArea("JAHEIRA")!StateCheck("JAHEIRA",CD_STATE_NOTVALID)~ THEN @21
==BDYNA IF ~InParty("DYNAHEIR")InMyArea("DYNAHEIR")!StateCheck("DYNAHEIR",CD_STATE_NOTVALID)~ THEN @22
==BKHALI IF ~InParty("KHALID")InMyArea("KHALID")!StateCheck("KHALID",CD_STATE_NOTVALID)~ THEN @23
==BAJANT IF ~InParty("AJANTIS")InMyArea("AJANTIS")!StateCheck("AJANTIS",CD_STATE_NOTVALID)~ THEN @24  = @25
==BKAGAI IF ~InParty("KAGAIN")InMyArea("KAGAIN")!StateCheck("KAGAIN",CD_STATE_NOTVALID)~ THEN @26
==BKIVAN IF ~InParty("KIVAN")InMyArea("KIVAN")!StateCheck("KIVAN",CD_STATE_NOTVALID)~ THEN @27
==BSHART IF ~InParty("SHARTEEL")InMyArea("SHARTEEL")!StateCheck("SHARTEEL",CD_STATE_NOTVALID)~ THEN @28
==BYESLI IF ~InParty("YESLICK")InMyArea("YESLICK")!StateCheck("YESLICK",CD_STATE_NOTVALID)~ THEN @29
==BXZAR IF ~InParty("XZAR")InMyArea("XZAR")!StateCheck("XZAR",CD_STATE_NOTVALID)~ THEN @30
==BMONTA IF ~InParty("MONTARON")InMyArea("MONTARON")!StateCheck("MONTARON",CD_STATE_NOTVALID)~ THEN @31
==BCORAN IF ~InParty("CORAN")InMyArea("CORAN")!StateCheck("CORAN",CD_STATE_NOTVALID)~ THEN @32
==BALORA IF ~InParty("ALORA")InMyArea("ALORA")!StateCheck("ALORA",CD_STATE_NOTVALID)~ THEN @33
==BGARRI IF ~InParty("GARRICK")InMyArea("GARRICK")!StateCheck("GARRICK",CD_STATE_NOTVALID)~ THEN @34
EXIT
...
IF ~Global("ACTAEREVCHOICE","LOCALS",1)~ THEN DO ~GiveItemCreate("sw1h06",LastTalkedToBy(),1,1,0)~ + GOODJOB.7
IF ~Global("ACTAEREVCHOICE","LOCALS",2)~ THEN DO ~GiveItemCreate("ax1h03",LastTalkedToBy(),1,1,0)~ + GOODJOB.7
IF ~Global("ACTAEREVCHOICE","LOCALS",3)~ THEN DO ~GiveItemCreate("sw1h09",LastTalkedToBy(),1,1,0)~ + GOODJOB.7
...
IF ~Global("ACTAEREVCHOICE","LOCALS",6)~ THEN DO ~GiveItemCreate("ax1h05",LastTalkedToBy(),1,1,0)~ + GOODJOB.7
...
IF ~Global("ACTAEREVCHOICE","LOCALS",13)~ THEN DO ~GiveItemCreate("chan05",LastTalkedToBy(),1,1,0)~ + GOODJOB.7
IF ~Global("ACTAEREVCHOICE","LOCALS",14)~ THEN DO ~GiveItemCreate("leat11",LastTalkedToBy(),1,1,0)~ + GOODJOB.7
IF ~Global("ACTAEREVCHOICE","LOCALS",15)~ THEN DO ~GiveItemCreate("leat07",LastTalkedToBy(),1,1,0)~ + GOODJOB.7
IF ~Global("ACTAEREVCHOICE","LOCALS",16)~ THEN DO ~GiveItemCreate("plat04",LastTalkedToBy(),1,1,0)~ + GOODJOB.7
END
